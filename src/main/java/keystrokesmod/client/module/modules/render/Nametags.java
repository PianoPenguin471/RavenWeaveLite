...
public class Nametags extends Module {
   ...
   @SubscribeEvent
   public void r(RenderLabelEvent e) {
      if (rm.isToggled()) {
         e.setCancelled(true);
      } else {
         if (e.getTarget() instanceof EntityPlayer && e.getTarget() != mc.thePlayer && ((EntityPlayer) e.getTarget()).deathTime == 0) {
            EntityPlayer en = (EntityPlayer)e.getTarget();
