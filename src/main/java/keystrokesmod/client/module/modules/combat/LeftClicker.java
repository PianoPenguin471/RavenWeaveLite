...
public class LeftClicker extends Module {
    ...
    public LeftClicker(){
        ...
        try {
            this.playerMouseInput = GuiScreen.class.getDeclaredMethod("mouseClicked", int.class, int.class, int.class);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void skidClick(RenderGameOverlayEvent er, TickEvent e) {
