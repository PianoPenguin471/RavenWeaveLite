   ...
   public void update() {
      ...
      for (ScorePlayerTeam team : Minecraft.getMinecraft().theWorld.getScoreboard().getTeams()) {
         for (String playerName : team.getMembershipCollection()) {
            if (!queue.contains(playerName) && team.getColorPrefix().equals("\u00A77\u00A7k") && !playerName.equalsIgnoreCase(Minecraft.getMinecraft().thePlayer.getDisplayName().getUnformattedText())) {
